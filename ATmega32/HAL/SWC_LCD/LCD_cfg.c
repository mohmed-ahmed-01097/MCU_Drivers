...
const u8 UnFilledHeart[LCD_CGRAM_LOCATIONS_NUM] = { 0x00, 0x0A, 0x15, 0x11, 0x0A, 0x04, 0x00, 0x00};
const u8 FilledHeart[LCD_CGRAM_LOCATIONS_NUM] 	= { 0x00, 0x0A, 0x1F, 0x1F, 0x0E, 0x04, 0x00, 0x00};
const u8 Mobile[LCD_CGRAM_LOCATIONS_NUM] 		= { 0x04, 0x1F, 0x11, 0x11, 0x1F, 0x1F, 0x1F, 0x1F};
const u8 Bell[LCD_CGRAM_LOCATIONS_NUM] 			= { 0x04, 0x0E, 0x0E, 0x0E, 0x1F, 0x00, 0x04, 0x00};
const u8 Silent[LCD_CGRAM_LOCATIONS_NUM]		= { 0x01, 0x03, 0x07, 0x1F, 0x1F, 0x07, 0x03, 0x01};
const u8 Music[LCD_CGRAM_LOCATIONS_NUM] 		= { 0x01, 0x03, 0x05, 0x09, 0x09, 0x0B, 0x1B, 0x18};
const u8 Plug[LCD_CGRAM_LOCATIONS_NUM] 			= { 0x0A, 0x0A, 0x1F, 0x11, 0x11, 0x0E, 0x04, 0x04};
const u8 Face[LCD_CGRAM_LOCATIONS_NUM] 			= { 0x00, 0x00, 0x0A, 0x00, 0x04, 0x11, 0x0E, 0x00};
const u8 Human[LCD_CGRAM_LOCATIONS_NUM] 		= { 0x04, 0x0E, 0x04, 0x0E, 0x15, 0x0E, 0x11, 0x00};
const u8 YogaHuman[LCD_CGRAM_LOCATIONS_NUM] 	= { 0x04, 0x0E, 0x0E, 0x04, 0x0E, 0x15, 0x0E, 0x11};
const u8 Cat[LCD_CGRAM_LOCATIONS_NUM] 			= { 0x1B, 0x15, 0x0E, 0x1F, 0x15, 0x1F, 0x0E, 0x00};
const u8 Paw[LCD_CGRAM_LOCATIONS_NUM] 			= { 0x15, 0x00, 0x0A, 0x1F, 0x1F, 0x0E, 0x00, 0x00};
