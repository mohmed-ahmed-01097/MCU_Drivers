...
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8SetPage(const u8 pu8String1[],const u8 pu8String2[]);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8SetString(const u8 pu8String[], u8 u8Row, u8 u8Col);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8SetChar(u8 u8Char, u8 u8Row, u8 u8Col);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8GetNum(s32* ps32Num, u8 u8Col, u8 u8Row);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8SetNum(s32 s32Num, u8 u8Col, u8 u8Row);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8GetFloat(f32* pf32Num, u8 u8Col, u8 u8Row);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8SetFloat(f32 f32Num, u8 u8Col, u8 u8Row);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8SetNum_Rise(s32 s32Num, u8 u8Col, u8 u8Row);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8SetFloat_Rise(f32 f32Num, u8 u8Col, u8 u8Row);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8GoTo_XY(u8 u8Col, u8 u8Row);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8ClrDisplay(void);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern void LCD_vidInitMode(void);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8Home(void);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8EntryMode(LCD_tenuEntryMode u8Mode);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8DisplayMode(LCD_tenuDisplayCursorControl u8Mode);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8ShiftMode(LCD_tenuDisplayCursorShift u8Shift);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8StoreSpecialChar(u8* pu8char, u8 u8Index);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8SetSpecialCharIndex(u8 u8Index, u8 u8Col, u8 u8Row);
...
/* Return      :	LBTY_tenuErrorStatus									  */
/* ************************************************************************** */
extern LBTY_tenuErrorStatus LCD_u8SetSpecialCharArray(u8* pu8char, u8 u8Col, u8 u8Row);
